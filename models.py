...
def slice_scanner_cnn_model(image_shape, alpha, l2_reg=0.0, l1_reg=0.0, dropout=0.0, activation='relu'):
    ...
    net = tf.keras.layers.AvgPool2D(pool_size=3,strides=2)(net)
    ...
    net = dense_layer(net,256,activation,dropout,l1_reg,l2_reg)
